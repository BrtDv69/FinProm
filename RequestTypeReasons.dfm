inherited frmRequestTypeReasons: TfrmRequestTypeReasons
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1086#1089#1085#1086#1074#1072#1085#1080#1081' '#1090#1080#1087#1086#1074' '#1079#1072#1103#1074#1086#1082
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited fdsMain: TpFIBDataSet
    ...
    AutoUpdateOptions.UpdateTableName = 'DIR_REQUEST_TYPE_REASONS'
    AutoUpdateOptions.GeneratorName = 'GEN_DIR_REQUEST_TYPE_REASONS_ID'
